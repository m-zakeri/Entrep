...
Below are the lecture files for this course (in PDF format):

- :fontawesome-solid-file-pdf: [Lecture 1: Introduction](files/Lecture1-Introduction.pdf)
- :fontawesome-solid-file-pdf: [Lecture 2: Business Founding Dilemmas](files/Lecture2-Founding-Dilemmas.pdf)
- :fontawesome-solid-file-pdf: [Lecture 3: Market Segmentation and Research](files/Lecture3-Market-Segmentation.pdf)
