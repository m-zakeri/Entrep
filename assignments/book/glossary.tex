...
%%% --- واژگان فصل ۴ (اخلاق داده) ---
\newword{data-ethics}{Data Ethics}{اخلاق داده}{اخلاق داده}
\newword{academia}{Academia}{محیط آکادمیک}{محیط‌های آکادمیک}
\newword{commercial-domain}{Commercial Domain}{حوزه تجاری}{حوزه‌های تجاری}
\newword{moral-theory}{Moral Theory}{نظریه اخلاقی}{نظریه‌های اخلاقی}
\newword{consequentialism}{Consequentialism}{پیامدگرایی}{پیامدگرایی}
\newword{deontological-ethics}{Deontological Ethics}{اخلاق وظیفه‌گرا}{اخلاق وظیفه‌گرا}
\newword{virtue-ethics}{Virtue Ethics}{اخلاق فضیلت}{اخلاق فضیلت}
\newword{tech-level}{Technological Level}{سطح فناورانه}{سطح فناورانه}
\newword{individual-level}{Individual Level}{سطح فردی}{سطح فردی}
\newword{org-level}{Organizational Level}{سطح سازمانی}{سطح سازمانی}
\newword{law}{Law}{حقوق}{حقوق}
\newword{algorithm}{Algorithm}{الگوریتم}{الگوریتم‌ها}
\newword{big-data}{Big Data}{کلان‌داده}{کلان‌داده‌ها}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
